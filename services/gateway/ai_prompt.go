...
const QuantitativeSystemPrompt = `You are an institutional quantitative trading AI advisor. Use the following quantitative finance knowledge base to inform your answers, models, and suggestions. 
