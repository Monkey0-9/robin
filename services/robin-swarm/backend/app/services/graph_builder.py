...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "Robin Swarm Graph",
        chunk_size: int = 500,
    ...
    def create_graph(
        ...
        *,
        ...
        graph_id = graph_id or f"robin-swarm_{uuid.uuid4().hex[:16]}"
        ...
        try:
            self.client.graph.create(
                graph_id=graph_id,
                name=name,
                description="Robin Swarm Social Simulation Graph"
            )
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            while True:
                ...
                for batch in getattr(page, "batches", None) or []:
                    ...
                    if (
                        metadata.get("robin-swarm_operation_id") == operation_id
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            items = [
                BatchAddItem(
                    ...
                    data=chunk,
                    data_type="text",
                    source_description="Robin Swarm source document chunk",
                    metadata={
                        "robin-swarm_operation_id": operation_id,
